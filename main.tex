...
%----------------------------------------------------------------
% For XeLaTeX: fontspec is essential. inputenc is generally not needed with XeLaTeX and utf8.
% Removing inputenc as it's not needed with XeLaTeX and can cause warnings.
...
% For italic variant, you might need to check font availability or load a fallback if not present.
% Example: \setCJKmainfont{Noto Serif CJK JP}[AutoFakeSlant]
...
% BibLaTeX setup - REMOVED AS PER YOUR REQUEST FOR IN-DOCUMENT BIBLIOGRAPHY
...
\hypersetup{
    ...
    pdfauthor={Kokuno Yumeto, Miroku Akagi},
    bookmarksopen=true,
    bookmarksnumbered=true
}

%----------------------------------------------------------------
% CUSTOM THEOREM ENVIRONMENTS (Looks solid, adding definition for conjecture/postulate)
%----------------------------------------------------------------
...
% (Adding definitions for \lambdabar, \Ztwo, \Zthree etc. to fix "Undefined control sequence" errors)
%----------------------------------------------------------------
% Spacetime
\newcommand{\BulkM}{M}
...
\fancyhf{}
\fancyhead[L]{\nouppercase{\leftmark}}
\fancyhead[R]{\textit{A Treatise on the Emergence of Reality}} % Shortened for header
\fancyfoot[C]{\thepage}
