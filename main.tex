...
% LaTeX Skeleton by Miroku Akagi                                               %
% For compilation with XeLaTeX                                                 %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
\setCJKmainfont{Noto Serif CJK JP} % As requested for author names
...
\usepackage{physics}         % For commands like \bra, \ket, \dv, \Tr
...
\usepackage{microtype}       % For improved typography and justification
...
\addbibresource{references.bib} % The bibliography file
...
\fancyhf{}
\fancyhead[L]{\nouppercase{\leftmark}}
\fancyhead[R]{\textit{A Treatise on the Emergence of Reality}}
\fancyfoot[C]{\thepage}
