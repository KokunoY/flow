...
% IMPORTANT: The \author command should now correctly use the CJK characters
% without a \begin{CJK*} here, as xeCJK should handle them globally.
% If `pdfauthor` in hyperref also had issues, they should be fixed by this.
\begin{document}
